...
\usepackage{graphicx,tikz,listings}
...
\begin{frame}
  ...
  Remove distortion and noise from degraded images, audio signals, etc.
  \begin{figure}
    \centering
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/signal}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/signal-noise}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/result}
  \end{figure}
\end{frame}
